        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              About <span className="bg-gradient-primary bg-clip-text text-transparent">Finitiix</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Card className="bg-gradient-card shadow-secondary">
              ...
              <CardContent>
                <CardDescription className="text-lg leading-relaxed">
                  By 2032, Finitiix aims to become a multi-sector powerhouse operating across Digital Solutions, 
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Finitiix is not bound by what exists today—we create what's next. 
            ...
            {[
              {
                ...
                description: "We're not just competing in the market—we're changing the market. Finitiix challenges the outdated belief that premium solutions must come with premium prices."
              },
              {
                badge: "Empowerment", 
              ...
              },
              {
                ...
                description: "At Finitiix, challenges are not roadblocks—they're opportunities. If someone says it can't be done, that's where we begin."
              }
            ].map((item, index) => (
